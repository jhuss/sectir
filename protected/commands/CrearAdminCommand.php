...
class CrearAdminCommand extends CConsoleCommand
{
    ...
    {
        $sql = <<<EOF
INSERT INTO {{users}} (`id`, `username`, `password`, `email`, `firstname`, `lastname`, `activation_key`, `created_on`, `updated_on`, `last_visit_on`, `password_set_on`, `email_verified`, `is_active`, `is_disabled`, `one_time_password_secret`, `one_time_password_code`, `one_time_password_counter`) VALUES
